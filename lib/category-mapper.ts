...
const KEYWORD_RULES: KeywordRule[] = [
  ...
  { keywords: /\b(sauce)\b(?!.*\b(hot|bbq|wing|dip)\b)/i, category: "Extract", subCategory: "Sauce" },
  { keywords: /\b(sugar)\b(?!.*\b(cookie|candy|gumm|brownie|chocolate|edible|chew)\b)/i, category: "Extract", subCategory: "Sugar" },
  ...
  { keywords: /\bgel\b(?!at)/i, category: "Topical", subCategory: "Gel" },
