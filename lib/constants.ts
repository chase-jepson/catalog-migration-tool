...
export const MAPPING_FIELDS: MappingFieldDef[] = [
  // Product Info
  { key: 'productIdentifier', label: 'Product ID / SKU', description: 'Unique ID per product (e.g. SKU, Product ID)', group: 'Product Info' },
  { key: 'productName', label: 'Product Name', description: 'Name of the product', group: 'Product Info', required: true },
  { key: 'brand', label: 'Brand', description: 'Brand name', group: 'Product Info' },
  { key: 'productCategory', label: 'Product Category', description: 'Product category or Product type', group: 'Product Info', required: true },
  { key: 'productSubCategory', label: 'Subcategory', description: 'Product subcategory or subtype', group: 'Product Info' },
  { key: 'status', label: 'Status', description: 'Active status or retired flag', group: 'Product Info' },
  { key: 'description', label: 'Description', description: 'Product description', group: 'Product Info' },
  ...
  // Attributes
  { key: 'tags', label: 'Internal Tags', description: 'Internal-only product tags (not visible to customers)', group: 'Attributes' },
  { key: 'effects', label: 'Effects', description: 'Product effects attribute', group: 'Attributes' },
  { key: 'flavor', label: 'Flavor', description: 'Flavor attribute', group: 'Attributes' },
  { key: 'ingredients', label: 'Ingredients', description: 'Ingredients attribute', group: 'Attributes' },

  // Display & Media
  { key: 'menuTitle', label: 'Menu / Online Title', description: 'Display name on menu', group: 'Display & Media' },
  { key: 'availableOnline', label: 'Available Online', description: 'Whether visible on online menu', group: 'Display & Media' },
  { key: 'imageFilename', label: 'Image', description: 'Image filename or URL fragment', group: 'Display & Media' },
  { key: 'externalCategory', label: 'External Category', description: 'Additional category info used for category resolution', hidden: true, group: 'Display & Media' },
  { key: 'variantIdentifier', label: 'Variant ID', description: 'Variant ID for composite key', hidden: true, group: 'Display & Media' },
];
