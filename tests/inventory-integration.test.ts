...
const EXPECTED_CSV = '/Users/chase/Downloads/CS Import Tool/Ethan Working/CS Tool - Inventory Import (Working).csv';
...
const filesExist = Object.values(FILES).every((f) => fs.existsSync(f)) && fs.existsSync(EXPECTED_CSV);
