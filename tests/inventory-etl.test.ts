...
describe('ETL Helpers', () => {
  ...
  describe('leftJoin', () => {
    it('merges matching rows', () => {
      ...
      const result = leftJoin(left, right, (r) => r.id, (r) => r.id);
    ...
    it('works with empty right side', () => {
      ...
      const result = leftJoin(left, [], (r) => r.id, (r: any) => r.id);
      expect(result).toHaveLength(1);
  ...
  describe('fullJoin', () => {
    it('1:1 matching merges both sides', () => {
      ...
      const result = fullJoin(left, right, (r) => r.id, (r) => r.id);
      expect(result).toHaveLength(1);
    ...
    it('handles both sides empty', () => {
      expect(fullJoin([], [], (r: any) => r.id, (r: any) => r.id)).toHaveLength(0);
    });
    ...
    it('right-only rows are de-duplicated by key', () => {
      ...
      const result = fullJoin(left, right, (r: any) => r.id, (r) => r.id);
...
describe('Inventory Transformer', () => {
  ...
  describe('processInventory', () => {
    ...
    it('derives location path and sellable/receiving flags', () => {
      ...
      const bsRow = dutchieInvRow({ 'Room': 'Back Stock', 'SKU': 'SKU-200', 'External package ID': 'PKG-2' });
  ...
  describe('processVendors', () => {
    it('deduplicates vendors by name', () => {
      const vendorRows = [
        { 'Vendor name': 'V1', 'Vendor code': 'L1', 'Abbreviation': '', 'Address': '', 'City': '', 'State': '', 'Postal code': '', 'Contact phone': '', 'Contact email': '' },
        { 'Vendor name': 'V1', 'Vendor code': 'L2', 'Abbreviation': '', 'Address': '', 'City': '', 'State': '', 'Postal code': '', 'Contact phone': '', 'Contact email': '' },
        { 'Vendor name': 'V2', 'Vendor code': 'L3', 'Abbreviation': '', 'Address': '', 'City': '', 'State': '', 'Postal code': '', 'Contact phone': '', 'Contact email': '' },
      ];
    ...
    it('merges vendor codes across rows and splits into licenses 1-3', () => {
      const vendorRows = [
        { 'Vendor name': 'V', 'Vendor code': 'LIC-A', 'Abbreviation': '', 'Address': '', 'City': '', 'State': '', 'Postal code': '', 'Contact phone': '', 'Contact email': '' },
        { 'Vendor name': 'V', 'Vendor code': 'LIC-B', 'Abbreviation': '', 'Address': '', 'City': '', 'State': '', 'Postal code': '', 'Contact phone': '', 'Contact email': '' },
        { 'Vendor name': 'V', 'Vendor code': 'LIC-C', 'Abbreviation': '', 'Address': '', 'City': '', 'State': '', 'Postal code': '', 'Contact phone': '', 'Contact email': '' },
      ];
      const result = processVendors(vendorRows, makeVendorMappings());
    ...
    it('splits comma-separated codes in a single cell', () => {
      const vendorRows = [
        { 'Vendor name': 'V', 'Vendor code': 'LIC-X, LIC-Y', 'Abbreviation': '', 'Address': '', 'City': '', 'State': '', 'Postal code': '', 'Contact phone': '', 'Contact email': '' },
      ];
      const result = processVendors(vendorRows, makeVendorMappings());
    ...
    it('builds distributor address from parts', () => {
      const vendorRows = [
        { 'Vendor name': 'V', 'Vendor code': '', 'Abbreviation': 'VA', 'Address': '123 Main', 'City': 'LA', 'State': 'CA', 'Postal code': '90001', 'Contact phone': '555-1234', 'Contact email': 'v@test.com' },
      ];
      const result = processVendors(vendorRows, makeVendorMappings());
    ...
    it('sets distributor type to Non-Arms Length', () => {
      const vendorRows = [
        { 'Vendor name': 'V', 'Vendor code': '', 'Abbreviation': '', 'Address': '', 'City': '', 'State': '', 'Postal code': '', 'Contact phone': '', 'Contact email': '' },
      ];
      const result = processVendors(vendorRows, makeVendorMappings());
    ...
    it('skips vendors with empty name', () => {
      const vendorRows = [
        { 'Vendor name': '', 'Vendor code': 'L1', 'Abbreviation': '', 'Address': '', 'City': '', 'State': '', 'Postal code': '', 'Contact phone': '', 'Contact email': '' },
      ];
      const result = processVendors(vendorRows, makeVendorMappings());
    ...
    it('license expiration date is today + 2 years', () => {
      const vendorRows = [
        { 'Vendor name': 'V', 'Vendor code': 'LIC-1', 'Abbreviation': '', 'Address': '', 'City': '', 'State': '', 'Postal code': '', 'Contact phone': '', 'Contact email': '' },
      ];
      const result = processVendors(vendorRows, makeVendorMappings());
  ...
  describe('processReceipts', () => {
    ...
    it('stacks adjustments with receipts', () => {
      ...
      const result = processReceipts(
        receiptRows, adjRows, new Set(['PKG-ABC']),
        makeReceiptMappings(), makeAdjustmentMappings(),
      );
    ...
    it('filters inactive invoices (no overlap with inventory)', () => {
      ...
      const result = processReceipts(
        receiptRows, [], new Set(['PKG-ACTIVE']),
        makeReceiptMappings(), makeAdjustmentMappings(),
      );
    ...
    it('filters out rows where Quantity equals 0 after summing', () => {
      ...
      const result = processReceipts(
        receiptRows, adjRows, new Set(['PKG-ZERO']),
        makeReceiptMappings(), makeAdjustmentMappings(),
      );
...
describe('Inventory Validator', () => {
  describe('validateInventoryRows', () => {
    ...
    it('excluded rows are skipped entirely', () => {
      const rows = [
        makeDerivedRow({ excluded: true, variantReferenceId: '', units: '-1' }),
      ];
      const result = validateInventoryRows(rows);
      expect(result.errorCount).toBe(0);
      expect(result.warningCount).toBe(0);
...
describe('Inventory CSV Generator', () => {
  describe('INVENTORY_OUTPUT_COLUMNS', () => {
    ...
    it('starts with TreezVariantId and ends with Distributor Representative 3 Notes', () => {
      ...
      expect(INVENTORY_OUTPUT_COLUMNS[INVENTORY_OUTPUT_COLUMNS.length - 1]).toBe('Distributor Representative 3 Notes');
    });
  });
